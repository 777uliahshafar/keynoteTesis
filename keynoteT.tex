...
\notec{Jelaskan gambar\small{(before n after pengembangan)} \scriptsize a2}
...
\notec{Pengembangan ini membagi kawasan menjadi dua bagian ruang yang berbeda. \scriptsize b1}
\notec{Kawasan tersebut seperti yang dilihat pada gambar (jelaskan gambar). Kedua ruang ini memiliki perbedaan yang cukup signifikan dilihat dari pelaku utama yang menjajakan makanan, pengaturan elemen­elemen, sifat­sifat elemen ruang, dan lain­lain. Umumnya ruang A dikenal dengan tatanan dan elemen buatan yang mewah dan penuh elemen buatan \scriptsize a1}
...
Oleh karena itu, mengetahui preferensi pengunjung pada masing-masing ruang tersebut adalah penting \citep{madureira2018}. \scriptsize a2}
\end{frame}
