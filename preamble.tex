...
\usepackage{xcolor}
\def\ccta{\cellcolor{red!40}}


\usepackage[noorphans,font=itshape,begintext=``, endtext=",vskip=0.5ex]{quoting}
...
%\setbeamercovered{transparent} % grey out overlay
\setbeamertemplate{note page}{\pagecolor{gray!10}\insertnote}\usepackage{palatino}
...
% Change background single frame
\newcommand{\cca}{\usebackgroundtemplate{%
\tikz\node[inner sep=0] {\includegraphics[height=\paperheight,width=\paperwidth]{bg5.png}};}}
\newcommand{\cco}{\setbeamercolor{background canvas}{bg=digiPH_ocean!90}}
\newcommand{\ccl}{\setbeamercolor{background canvas}{bg=digiPH_leaf!90}}
\newcommand{\ccs}{\setbeamercolor{background canvas}{bg=digiPH_stem!90}}
\newcommand{\ccg}{\usebackgroundtemplate{%
\tikz\node[inner sep=0] {\includegraphics[height=\paperheight,width=\paperwidth]{bg4.png}};}}

\newcommand{\ntex}{\setbeamercolor{normal text}{fg=white}\usebeamercolor*{normal text}}

\newcommand{\myft}[1]{\frametitle{\textcolor{white}{#1}}}
...
\usepackage{tikz}
\usetikzlibrary{shapes.geometric, arrows, arrows.meta,tikzmark}
